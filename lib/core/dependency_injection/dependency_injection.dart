...
import '../../features/rocket_details/logic/cubit/rocket_cubit.dart';
...
Future<void> setUpDependencyInjections() async {
  ...
  getIt.registerLazySingleton(
      () => RocketService(rocketProvider: getIt<RocketProvider>()));
  getIt.registerFactory(() => GetAllRocketsCubit(
      getIt<GetAllRocketsRepository>(), getIt<RocketService>()));
  getIt.registerFactory(
      () => RocketCubit(rocketService: getIt<RocketService>()));
}
