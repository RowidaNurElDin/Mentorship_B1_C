          ...
          itemBuilder: (context, index) {
            return BlocConsumer<OnboardCubit, OnboardState>(
              ...
              builder: (context, state) {
                return state is GetBoardingLoadingState
                    ? const Center(
                        child: CircularProgressIndicator(
                          color: ColorsManager.blueColor,
                        ),
                      )
                    : state is GetBoardingFailedState
                        ? ErrorWidget(
                            'Try again',
                          )
                        : Column(
                            ...
                            children: [
                              CustomImage(
                                ...
                                imageUrl: onboardCubit
                                    .launcherModel.links!.patch!.small,
                              ),
                              CustomImage(
                              ...
                              CustomButton(
                                onTap: () {
                                  if (onboardCubit.controller.page! <
                                      onboardCubit.onboardTitles.length -
                                          1.toDouble()) {
                                    onboardCubit.controller.nextPage(
